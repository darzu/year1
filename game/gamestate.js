...
export const endGame = eventWizard("end-game", () => [[ShipPropsDef, ShipLocalDef, PositionDef]], ([ship]) => {
    console.log("end");
...
export const restartGame = eventWizard("restart-game", () => [[ShipPropsDef]], ([ship]) => {
    console.log("restart");
...
export function registerGameStateSystems(em) {
    em.registerSystem(null, [GameStateDef, PhysicsTimerDef, HostDef], ([], res) => {
