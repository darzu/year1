...
export function registerBoatSystems(em) {
    em.registerSystem([BoatLocalDef, BoatPropsDef, RotationDef, LinearVelocityDef, AuthorityDef], [PhysicsTimerDef, MeDef], (boats, res) => {
...
export function spawnBoat(loc, parentId, wheelDir, facingRight) {
