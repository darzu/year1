...
export class EntityManager {
    ...
    registerOneShotSystem(cs, rs, callback) {
        var _a, _b;
        const name = (_a = callback.name) !== null && _a !== void 0 ? _a : "oneShot" + this.nextOneShotSuffix++;
        // use one bucket for all one shots. Change this if we want more granularity
        this.stats["__oneShots"] = (_b = this.stats["__oneShots"]) !== null && _b !== void 0 ? _b : {
            calls: 0,
            queries: 0,
            callTime: 0,
            queryTime: 0,
    ...
    callOneShotSystems() {
        ...
        this.oneShotSystems = this.oneShotSystems.reduce((keptSystems, s) => {
            ...
            for (let r of s.rs) {
                ...
                haveAllResources && (haveAllResources = !!this.getResource(r));
            }
            if (haveAllResources) {
