...
export function registerSyncSystem(em) {
    ...
    em.registerSystem([AuthorityDef, SyncDef], [TimeDef, NetTimerDef, MeDef], sync, "netSync");
}
export function registerUpdateSystem(em) {
    ...
    em.registerSystem([PeerDef, InboxDef, OutboxDef], [TimeDef, MeDef, NetStatsDef], update, "netUpdate");
}
